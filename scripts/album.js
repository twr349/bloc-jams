    ...
    var template =
      ...
      var clickHandler = function() {
        ...
        if (currentlyPlayingSong !== null) {
          var currentlyPlayingTab = $('.song-item-number[data-song-number="' + currentlyPlayingSong +'"]');
          currentlyPlayingTab.html(currentlyPlayingSong);
        }
      ...
      var onHover = function(event){
         ...
         var songNumber = songNumberTab.attr('data-song-number');
